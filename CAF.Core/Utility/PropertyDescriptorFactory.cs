...
namespace CompositeApplicationFramework.Utility
{
    ...
    public static class PropertyDescriptorFactory
    {
        ...
        ///     a component and gets this property's value.
        /// </param>
        /// <param name="setter">
        ///     An action that takes
        ///     a component and sets this property's value.
        /// </param>
        ...
        {
            return InternalPropertyDescriptorFactory.CreatePropertyDescriptor(name, getter, setter);
        }
        ...
        public static PropertyDescriptor CreatePropertyDescriptor<TComponent, TProperty>(
            ...
            Func<TComponent, TProperty> getter)
        {
            return InternalPropertyDescriptorFactory.CreatePropertyDescriptor(name, getter);
        }
        ...
        ///     A System.Type that represents
        ///     the type of component to which this property descriptor binds.
        /// </param>
        ...
        /// <param name="propertyType">
        ///     A System.Type
        ///     that represents the data type for this property.
        /// </param>
        /// <param name="getter">
        ///     A function that takes
        ///     a component and gets this property's value.
