...
namespace CompositeApplicationFramework.Utility.Localization.Engine
{
    ...
    /// <summary>
    ///     An extension to the <see cref="XAMLMarkupExtensions.Base.TargetInfo" /> class with WeakReference instead of direct
    ///     object linking.
    /// </summary>
    public class SafeTargetInfo : TargetInfo
    {
        ...
        /// <summary>
        ///     Creates a new <see cref="SafeTargetInfo" /> based on a <see cref="XAMLMarkupExtensions.Base.TargetInfo" />
        ///     template.
        /// </summary>
        ...
        {
            return new SafeTargetInfo(
                targetInfo.TargetObject,
                targetInfo.TargetProperty,
                targetInfo.TargetPropertyType,
                targetInfo.TargetPropertyIndex);
        }
    }
}