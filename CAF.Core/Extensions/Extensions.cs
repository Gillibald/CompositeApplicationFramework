...
namespace CompositeApplicationFramework.Extensions
{
    ...
    public static class Extensions
    {
        ...
        public static TResponse UseAndDispose<T, TResponse>(this T source, Func<T, TResponse> func)
            where T : IDisposable
        {
            using (source)
            {
        ...
        public static IEnumerable<T> GetCustomAttributes<T>(this ICustomAttributeProvider attributeProvider,
        ...
        public static PropertyChangeWatcher AddWatcher(this INotifyPropertyChanged source, string propertyName,
            Action handler)
        {
        ...
        public static IComparer<string> GetStringComparer(this CultureInfo cultureInfo,
