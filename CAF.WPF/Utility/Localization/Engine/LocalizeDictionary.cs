...
using CompositeApplicationFramework.Utility.Localization.Providers;
...
[assembly:
    XmlnsDefinition("http://wpflocalizeextension.codeplex.com",
        "CompositeApplicationFramework.Utility.Localization.Engine")]
[assembly:
    XmlnsDefinition("http://wpflocalizeextension.codeplex.com",
        "CompositeApplicationFramework.Utility.Localization.Extensions")]
[assembly:
    XmlnsDefinition("http://wpflocalizeextension.codeplex.com",
        "CompositeApplicationFramework.Utility.Localization.Providers")]
[assembly:
    XmlnsDefinition("http://wpflocalizeextension.codeplex.com",
        "CompositeApplicationFramework.Utility.Localization.TypeConverters")]
    ...
    public sealed class LocalizeDictionary : DependencyObject, INotifyPropertyChanged
    {
        ...
        public bool GetIsInDesignMode()
        {
            lock (SyncRoot)
            {
                ...
                if (Dispatcher == null || Dispatcher.Thread == null || !Dispatcher.Thread.IsAlive)
                {
                        ...
                        _isInDesignMode =
                            (bool)
                                Dispatcher.Invoke(
                                    ...
                                    new Func<bool>(GetIsInDesignMode));
                    }
                    catch (Exception)
                    {
        ...
        /// </summary>
        public static readonly DependencyProperty SeparationProperty = DependencyProperty.RegisterAttached(
            "Separation",
            typeof (string),
            typeof (LocalizeDictionary),
        ...
        /// <param name="obj">The dependency object.</param>
        /// <param name="args">The event argument.</param>
        private static void SetProviderFromDependencyProperty(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs args)
        {
        ...
        /// <param name="obj">The dependency object.</param>
        /// <param name="args">The event argument.</param>
        private static void SetDefaultProviderFromDependencyProperty(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs args)
        {
        ...
        /// <param name="obj">The dependency object.</param>
        /// <param name="args">The event argument.</param>
        private static void SetSeparationFromDependencyProperty(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs args)
        {
        }
        ...
        /// <param name="obj">The dependency object.</param>
        /// <param name="args">The event argument.</param>
        private static void SetIncludeInvariantCultureFromDependencyProperty(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs args)
        {
        ...
        /// <param name="obj">The dependency object.</param>
        /// <param name="args">The event argument.</param>
        private static void SetDisableCacheFromDependencyProperty(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs args)
        {
            if (args.NewValue is bool)
        ...
        /// <param name="obj">The dependency object.</param>
        /// <param name="args">The event argument.</param>
        private static void SetOutputMissingKeysFromDependencyProperty(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs args)
        {
            if (args.NewValue is bool)
        ...
        /// </summary>
        //private ParentNotifiers _parentNotifiers = new ParentNotifiers();
        ...
        private void AvailableCulturesCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            Dispatcher.BeginInvoke(
                new Action<NotifyCollectionChangedEventArgs>(
                    args =>
                    {
                        if (args.NewItems != null)
                        {
                            foreach (
                                var c in
                                    from CultureInfo c in args.NewItems
                                    where !MergedAvailableCultures.Contains(c)
                                    select c)
                            {
                        ...
                        if (args.OldItems != null)
                        {
                            foreach (
                                var c in
                                    from CultureInfo c in args.OldItems
                                    where MergedAvailableCultures.Contains(c)
                                    select c)
                            {
                        ...
                        if (!_includeInvariantCulture && MergedAvailableCultures.Count > 1
                            && MergedAvailableCultures.Contains(CultureInfo.InvariantCulture))
                        {
        ...
        /// <summary>
        ///     Gets the default <see cref="CultureInfo" /> to initialize the <see cref="LocalizeDictionary" />.
        ...
        {
            get => _culture ?? (_culture = DefaultCultureInfo);
            ...
            set
            {
                ...
                if (!GetIsInDesignMode())
                {
                    ...
                    {
                        if (Equals(c, CultureInfo.InvariantCulture) && !IncludeInvariantCulture)
                        {
                        }
                ...
                if (Equals(_culture, newCulture)) return;
        ...
        /// <summary>
        ///     Gets or sets a flag that determines, if the CurrentThread culture should be changed along with the Culture
        ///     property.
        /// </summary>
        public bool SetCurrentThreadCulture
        {
            ...
            set
            {
                if (_setCurrentThreadCulture == value) return;
        ...
        /// <summary>
        ///     Gets or sets the flag indicating if the invariant culture is included in the
        ///     <see cref="LocalizeDictionary.MergedAvailableCultures" /> list.
        /// </summary>
        ...
        public ILocalizationProvider DefaultProvider
        {
            ...
            set
            {
                if (_defaultProvider == value) return;
                ...
                foreach (var c in _defaultProvider.AvailableCultures.Where(c => !MergedAvailableCultures.Contains(c)))
                {
                    MergedAvailableCultures.Add(c);
                }
            }
        ...
        public ObservableCollection<CultureInfo> MergedAvailableCultures
        {
            get
            {
                if (_mergedAvailableCultures != null) return _mergedAvailableCultures;
        ...
        public object GetLocalizedObject(string key, DependencyObject target, CultureInfo culture)
        {
            ...
            var provider = target?.GetValue(GetProvider) ?? DefaultProvider;
            ...
            CultureInfo cultureToUse)
        {
            ...
            return ResourceKeyExists(
                resourceAssembly + ":" + resourceDictionary + ":" + resourceKey,
                cultureToUse,
                provider);
        }
