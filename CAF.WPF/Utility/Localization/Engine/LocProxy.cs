...
namespace CompositeApplicationFramework.Utility.Localization.Engine
{
    ...
    public class LocProxy : FrameworkElement
    {
        ...
        ///     The result.
        /// </summary>
        public static DependencyPropertyKey ResultProperty = DependencyProperty.RegisterReadOnly(
            "Result",
            typeof (string),
            typeof (LocProxy),
        ...
        {
            get => (string) GetValue(ResultProperty.DependencyProperty) ?? Source.ToString();
