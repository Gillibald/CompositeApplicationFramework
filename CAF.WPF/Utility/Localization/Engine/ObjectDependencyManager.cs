...
namespace CompositeApplicationFramework.Utility.Localization.Engine
{
    ...
    public static class ObjectDependencyManager
    {
        ...
        public static bool AddObjectDependency(WeakReference weakRefDp, object objToHold)
        {
            ...
            if (objToHold == null)
            {
                throw new ArgumentNullException(nameof(objToHold),
                    Resources.ObjectDependencyManager_AddObjectDependency_The_objToHold_cannot_be_null);
            }
            ...
            if (objToHold.GetType() == typeof (WeakReference))
            {
                throw new ArgumentException(
                    Resources.ObjectDependencyManager_AddObjectDependency_objToHold_cannot_be_type_of_WeakReference,
                    nameof(objToHold));
            }
