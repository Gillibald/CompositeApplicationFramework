...
namespace CompositeApplicationFramework.Icons
{
    #region Dependencies
    ...
    public static class IconFactory
    {
        ...
        {
            var uri = new Uri(
                $@"pack://application:,,,/CompositeApplicationFramework.Presentation;component/Icons/{iconName}",
